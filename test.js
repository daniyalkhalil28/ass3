...
const test = async () => {
    ...
    console.log('2) Checking no pending item');
    ...
    await driver.findElement(By.css('#input')).sendKeys('milk');
    ...
    console.log('5) Checking deleting item');
